...
Returns a set of temporary security credentials for applications/clients who have been authenticated through client grants provided by your identity provider. Example providers include WSO2, KeyCloak etc.
